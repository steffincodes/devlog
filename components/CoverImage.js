...
export default function CoverImage({ title, slug }) {
  ...
  const image = (
    ...
    >
      ...
      />
      <div
        className={`font-effect-${googleFontsSetup.fontEffect}`}
        style={{
          position: "absolute",
          top: "50%",
          left: "50%",
          ...
          fontSize: "7vw",
          userSelect: "none",
          fontFamily: googleFontsSetup.fontFamily,
        }}
      >
        {title}
      </div>
  ...
  return (
    <div className="-mx-5 sm:mx-0">
      ...
      <style jsx global>{`
        @import url("https://fonts.googleapis.com/css?family=${jsCleanText(
          googleFontsSetup.fontFamily
        )}&text=${jsCleanText(title)}&effect=${googleFontsSetup.fontEffect}");
